Funktionalität: Speichern der Personenstammdaten
Als Verwaltungsfachangestellter möchte ich eine Person mit ihrem Vor- und Zunahmen, sowie Geburtsdatum anlegen können.

Szenario: Neue Personendaten eingeben
